...
<div id="page-content">     
    ...
    <div class="container">
        ...
        WHERE code_category = 'PROMO' AND items_status = 'Active' OR
        code_category = 'REBATABLE' AND items_status = 'Active' OR
        code_category = 'BUY ONE GET ANY' AND items_status = 'Active' OR
        code_category = 'BUY ONE GET TWO' AND items_status = 'Active' 
        UNION 
        ...
        WHERE code_category = 'PROMO' AND package_status = 'Active' OR
        code_category = 'REBATABLE' AND package_status = 'Active' OR
        code_category = 'BUY ONE GET ANY' AND package_status = 'Active' OR
        code_category = 'BUY ONE GET TWO' AND package_status = 'Active'
