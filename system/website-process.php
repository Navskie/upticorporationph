              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered table-hover">
                    ...
                    <?php
                        ...
                        $order_sql = "SELECT * FROM web_transaction WHERE trans_status= 'On Process' AND trans_country = '$employee' OR trans_status= 'In Transit' AND trans_country = '$employee' ORDER BY id DESC";
